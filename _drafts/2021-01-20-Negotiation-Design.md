...
I finally got around to reading [Getting to Yes](http://www.fd.unl.pt/docentes_docs/ma/AGON_MA_25849.pdf ), which several friends have recommended. It is a fantastic crash course in negotiation.
I also couldn't help but notice the similarities between negotiation and design.
...
A health continuing relationship can't be maintained if either side's interests are failed. Timelines and budgets in particular tend to feel in direct competition. Meaning midpoints or unbalanced agreements usually fail both parties.
...
The book also suggests separating idea generation form selection. This is a generally useful brainstorming technique, sometimes described as flare and focus. Eliminating critical evaluations during ideation broadens the scope and variety of idea.
...
It's easy to get blinders and only see outcomes in one vein, especially when working in a concrete field like software. However, it's important to keep in mind alternatives to creating a solution: continuing with process as-is, more manual processes, processes using existing tools (excel?).
