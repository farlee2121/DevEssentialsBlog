...
- Understandable and tracable async flow 
...
- It directly couples the notion of the communication method to business logic
  - The business flows cannot be used in other scenarios with a non-queued fulfillment without breaking semanical expectations
...
- Implement a decorator on the large domain service
  ...
  -  Likely involves methods that cannot readily be made async or fit more restricitive async patterns
