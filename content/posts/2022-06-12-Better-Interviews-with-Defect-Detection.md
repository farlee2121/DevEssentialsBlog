...
I emphasize [understanding a problem well](../posts/2021-01-29-Going-Fast-is-Going-Well.md) before writing code. As such, I often spend most of my coding interviews understanding the problem and writing very little code.
...
Detection-based assessments are [increment, stable, and additive](../posts/2022-02-25-Stable-Incremental-Additive.md) allowing [progressive design](../posts/2022-03-04-Progressive-Design.md). Each code sample represents a self-contained assessment for specific skills. Larger exams can be composed by selecting many individual samples that target component skills.
