...
- requirements -> tests (usually [Test Api](https://codewithspoon.com/2019/12/stop-corrupting-yourself-test-against-abstractions/) or [Gherkin-named tests](../post/2021-12-12-Gherking-Test-Names.md))
...
- motivations and trade-offs -> most typically in [ducks](../post/2021-05-21-Duck-Structure.md) or [Architectural Decision Records](https://adr.github.io/)
...
- [Design of Design](https://en.wikipedia.org/wiki/The_Design_of_Design)
  -  The source of [duck docs](../post/2021-05-21-Duck-Structure.md) and their [key elements](../post/DevEssentials/2018-12-08-Spec-Docs.md)
