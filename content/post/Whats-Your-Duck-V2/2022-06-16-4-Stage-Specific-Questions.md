...
The trio of what, when, and how much [inform if a solution is even worth pursuing](../../post/2020-07-16-iDesign-Project-Summary.md).
...
- [Volatility Analysis](../../post/2022-02-18-Programming-is-Problem-Modeling.md#adaptability-volatility-analysis-as-essence-discovery): Using likelihood of change to understand how fundamental concepts are to a problem
...
- [IDesign](../../post/2020-07-03-iDesign-Visual-Summary.md)
...
- [Patterns in practice](../../post/2021-07-09-Patterns-in-Practice.md)
