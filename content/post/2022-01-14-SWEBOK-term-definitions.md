...
SWEBOK includes debugging (running the software with ability to stop at certain lines of code & inspect values) in this category. Most often this category refers to automated tests (e.g. unit tests). I have several posts on [different kinds of tests](../post/2021-08-30-Test-Types-and-Lifecycle-Phases.md) and [when to use them](../post/2021-12-05-What-tests-measure.md).
...
I've previously discussed software development as [a series of problem transformations](../post/2021-08-13-Swebok-transform-view.md) and how this process [produces artifacts for control](../post/2021-08-20-SWEBOK-transform-SCM.md).
